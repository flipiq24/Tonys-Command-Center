        ...
        <div ref={menuRef} style={{ position: "relative" }}>
          ...
          {open && (
            <div style={{
              ...
              {menuItem(<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0018 0V5"/><path d="M3 12a9 3 0 0018 0"/></svg>, "🧠 Master Task Brain", null, () => onSetView("brain"))}
