        ...
        <div ref={menuRef} style={{ position: "relative" }}>
          ...
          {open && (
            <div style={{
              ...
              {menuItem(<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>, "Ideas", null, () => onSetView("ideas"))}
